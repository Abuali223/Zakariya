  ...
  dbp = new Promise((resolve,reject)=>{
    ...
    req.onupgradeneeded = ()=> {
      ...
      if (!db.objectStoreNames.contains('progress'))
        db.createObjectStore('progress', { keyPath: ['user','item'] });
    };
...
function tutor(){
  $('#page').innerHTML = `<h2>AI Tutor</h2><div class="card">Serverdagi SI ulansa ishlaydi.</div>`;
}
function parent(){
  $('#page').innerHTML = `
