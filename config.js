...
// Project Settings → API sahifasidan olingan qiymatlar:

// 1) Project URL (faqat .supabase.co gacha!  /functions/... QO‘YILMAYDI)
window.SUPABASE_URL = "https://eulfjekrjdtprffszxcf.supabase.co";
